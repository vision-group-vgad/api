...
export const getCostOptimization = (req, res) => {
  try {
    ...
    // Build monthly legal spend trend
    ...
    const legalSpendTrend = Object.entries(legalSpendTrendMap)
      ...
      .sort((a, b) => new Date(a.month) - new Date(b.month)); // sort chronologically
